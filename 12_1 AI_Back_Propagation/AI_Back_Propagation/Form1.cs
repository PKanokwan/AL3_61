...
namespace AI_Back_Propagation
{
    public partial class Form1 : Form
    {
        ...
        public string  chkPattern()
        {
            ...
            ArrayList In_pattern=new ArrayList(){"00.850.850","00.80.91","10.830.780","20.70.960","20.680.80","20.650.71","10.640.651","00.720.950","00.690.70","20.750.80","00.750.71","10.720.91","10.810.750","20.710.81"};
        ...
        private void calculate(string ou)
        {
            ...
            double x1 = Convert.ToDouble(0), x2 = Convert.ToDouble(TemIn), x3 = Convert.ToDouble(HumiIn), x4 = Convert.ToDouble(WindyNum);
            ...
            while (true)
            {
                ...
                dataGridView1.Rows.Add(sumE, y1);
